...
<body>
				...
				<div class="row w-100">
					<div class="col-lg-4 mx-auto">
						<div class="auth-form-light text-left p-5">
							...
							<h4>Merhaba!</h4>
							<h6 class="font-weight-light">Admin Değilsen Geri Dön!</h6>
							<div id="LoginAlert" ></div>
							<form class="pt-3" action="" onsubmit="return false;">
								<div class="form-group">
									<input type="text" class="form-control form-control-lg" id="username" autocomplete="off" placeholder="Kullanıcı Adı">
								</div>
								<div class="form-group">
	...
	<script src="<?php echo VAADIR; ?>/assets/js/user.js"></script>
