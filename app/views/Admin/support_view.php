					...
					<?php foreach ($Support_Replies_Data_F as $Support_Replies_Data_R) { ?>
						...
						<div class="form-group" style="border:0.1px solid #ddd;padding: 15px">
							<label style="margin-bottom: 20px">
								...
								if($Support_Replies_Data_R['admin'] != 1) {echo ' <font style="color:#fe7c96">(</font><font style="color:#57c7d4">Müşteri</font><font style="color:#fe7c96">)</font>';} else{echo ' <font style="color:#fe7c96">(</font><font style="color:#1bcfb4">Siz</font><font style="color:#fe7c96">)</font>';}
