                    ...
                    <form action="" method="post" name="wizard">
                        ...
                        <div class="buttons">
                            <?php if ( $this->config['show_back_button'] && $this->vars['step_num'] > 1 && $this->vars['step_num'] != $this->vars['total_steps'] ): ?>
                                <input type="submit" name="button_back" value="Geri" class="button button-back" />
                            <?php endif; ?>
                            <?php if ( $this->vars['step_num'] < $this->vars['total_steps'] ): ?>
                                <input type="submit" name="button_next" value="İleri" class="button button-next" />
                            <?php endif; ?>
                            <?php if ( $this->vars['total_steps'] == 1 ): ?>
                                <input type="submit" name="button_next" value="Tamam" class="button button-next" />
                            <?php endif; ?>
                            <?php /* if ( $this->vars['step_num'] == 1 ): ?>
                                <div class="info" style="padding-top: 10px">If your upgrading PHPMyLicense, please <a href="../update.php">click here</a>.</div>
                            <?php endif; */ ?>
                        </div>
                    </form>
                </div>
